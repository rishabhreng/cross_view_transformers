...
from cross_view_transformer.callbacks.visualization_callback import (
...
def main(cfg):
    # print(os.environ['CUDA_'])
    # wandb.login(key='d6d38f805ba1a2ef7a7a7ffb3d2933e36eb8ad1e', relogin=True)
    ...
    callbacks = [
        ...
        ModelCheckpoint(
            filename="model", every_n_train_steps=cfg.experiment.checkpoint_interval
        ),
